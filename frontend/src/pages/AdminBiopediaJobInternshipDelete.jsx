...
export default function AdminBiopediaJobInternshipDelete() {
  ...
  const handleDelete = async (e) => {
    ...
    try {
      ...
      setMessage(res.data.message || "Job internship deleted successfully.");
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      <h1 className="text-4xl font-bold mb-4">
        Admin Biopedia Job Internship Delete Page
      </h1>
