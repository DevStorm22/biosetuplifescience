...
export default function AdminBiopediaJobFellowshipUpdate() {
  ...
  const API_BASE = "http://localhost:5000/biopediajobsfellowship";
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      <h1 className="text-4xl font-bold mb-4">Update Job Fellowship</h1>
