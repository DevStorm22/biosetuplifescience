...
export default function AdminBiopediaJobFellowshipView() {
  ...
  const fetchJobs = async () => {
    try {
      const res = await axios.get("http://localhost:5000/biopediajobsfellowship/");

      // Force React to re-render even if identical array arrives
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      <h1 className="text-4xl font-bold mb-4">
        Admin Biopedia Job Fellowship View
      </h1>
