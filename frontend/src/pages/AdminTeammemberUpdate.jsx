export default function AdminTeammemberUpdate() {
  return (
    <div className="flex flex-col justify-center items-center min-h-screen p-3 gap-5">
      <h1 className="text-4xl font-bold mb-4">Admin Team member update</h1>
      <form className="bg-white p-8 rounded-xl shadow-xl flex flex-col gap-4 w-4xl">
        <div className="mb-4">
          ...
          <input
            ...
            id="team-member-id"
            name="team-member-id"
            placeholder="Enter team member ID to update"
            required
          />
        </div>
        <div className="mb-4">
