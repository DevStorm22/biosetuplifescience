...
export default function AdminBiopediaJobInternshipView() {
  ...
  const fetchJobs = async () => {
    try {
      const res = await axios.get("http://localhost:5000/biopediajobsinternship/");
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      <h1 className="text-4xl font-bold mb-4">
        Admin Biopedia Job Internship View
      </h1>
