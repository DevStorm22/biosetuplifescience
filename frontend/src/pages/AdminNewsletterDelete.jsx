export default function AdminNewsletterDelete() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      <h1 className="text-4xl font-bold mb-4">Admin Newsletter Delete Page</h1>
      <form className="bg-white p-8 rounded-xl shadow-xl flex flex-col gap-4 w-4xl">
        <div className="mb-4">
          ...
          <input
            ...
            id="newsletter-id"
            name="newsletter-id"
            placeholder="Enter newsletter ID to delete"
            required
          />
        </div>
        <button
